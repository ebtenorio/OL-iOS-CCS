...
{
	public partial class StoresViewController : UIViewController
	{
		...
		public StoreListingsController StoreListingsController { get; set; }

		private DALFacade DalFacade = new DALFacade();

		public StoresViewController (IntPtr handle) : base (handle)
		{
		}
...
//			ProviderField.Text = ProviderName; 
...
//			//			RefreshAddresses ();
//
			this.ProviderFieldLabel.Text = ProviderName;
			this.StoreIDFieldLabel.Text = Customer.Code;
			this.FirstNameFieldLabel.Text = Customer.ContactFirstName;
			this.LastNameFieldLabel.Text = Customer.ContactLastName;
			this.EmailAddressFieldLabel.Text = Customer.ContactEmail;
			this.ContactNumberFieldLabel.Text = Customer.ContactMobile;
			this.StateLabel.Text = Customer.StateCode;
		...
		partial void saveCustomerRecord (Foundation.NSObject sender) {
			...
			StoreListingsController.TableView.ReloadData();
			DismissViewController(true, null);
		}
